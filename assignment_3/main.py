...
# Expanding the program with the functions from assignment 3
# - Sobel edge detection (line 164)
# - Canny edge detection (line 180)
# - Template match (line 195)
# - Resize with zoom (line 227)

# Using lambo.png as default
...
def zoom_resize(image, scale_factor: int, up_or_down: str):
    if image is None:
        ...
        return
    if up_or_down is not "down" or up_or_down is not "up":
